...
- **Alternate Sequence:**
User profile does not have any notes or None of the them matched to the search file. 
    1. Use will not see any file after entering the search box, message prompt “File is not found!”.
